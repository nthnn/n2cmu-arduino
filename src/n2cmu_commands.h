 ...
 * 
 * The `N2CMUCommands` enumeration defines a set of command constants that are utilized
 * for communication between the main microcontroller and the N2CMU device. Each command
 * represents a specific operation or action to be performed by the N2CMU device.
 */
typedef enum N2CMUCommands {
